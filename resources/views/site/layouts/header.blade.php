...
<html lang="en">
<head>
<title>TigerThai | Centro de treinamento</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="O melhor CT de treinamento e Artes Marciais">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" type="text/css" href="{{ asset('site/styles/bootstrap-4.1.2/bootstrap.min.css')}}">
...
<link href="{{ asset('site/plugins/colorbox/colorbox.css')}}" rel="stylesheet" type="text/css')}}">
